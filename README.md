...
На собеседования часто спрашивают про конструкцию Using. Зачем она, во что превращает ее компилятор, как с ней жить, что за объекты которые реализуют интерфейс IDispsable. 

- using упрощает работу с такими объектами, тоесть не надо задумывать об очистки памяти после выполнения работы с такими объектами.
